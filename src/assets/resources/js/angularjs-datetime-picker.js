(function(e) {
  ...
  e.module('angularjs-datetime-picker', []);
  ...
  e.module('angularjs-datetime-picker').factory('DatetimePicker', DatetimePicker);
  ...
  var DatetimePickerCtrl = function($compile, $document) {
    ...
    this.openDatetimePicker = function(options) {
      ...
      var div = e.element('<div datetime-picker-popup ng-cloak></div>');
      ...
      options.scope = options.scope || e.element(triggerEl).scope();
  ...
  e.module('angularjs-datetime-picker').controller('DatetimePickerCtrl', DatetimePickerCtrl);
  ...
  var datetimePickerPopup = function($locale, dateFilter){
    ...
    var linkFunc = function(scope, element, attrs, ctrl) { //jshint ignore:line
      ...
      scope.$applyAsync( function() {
        ctrl.triggerEl = e.element(element[0].triggerEl);
      ...
      scope.setDate = function (evt) {
        var target = e.element(evt.target)[0];
  ...
  e.module('angularjs-datetime-picker').directive('datetimePickerPopup', datetimePickerPopup);
  ...
  e.module('angularjs-datetime-picker').directive('datetimePicker', datetimePicker);
